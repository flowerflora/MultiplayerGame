...
struct Game {
	...
	std::vector<glm::vec2> shells = {glm::vec2(5.0f,5),glm::vec2(-5.0f,5),glm::vec2(5.0f,-5),glm::vec2(-5.0f,-5),glm::vec2(0.0f,0)};
	...
	//player constants:
	inline static constexpr float PlayerRadius = 1.5f;
